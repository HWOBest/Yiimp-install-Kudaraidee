...
################################################################################
    ...
    apt_install php7.3-memcache -y
    apt_install php7.3-memcached -y
    echo -e "$GREEN Done...$COL_RESET"
    ...
    echo
    echo
    echo -e "$CYAN => Installing Yiimp. Fork Kudaraidee... $COL_RESET"
    echo
    ...
    echo -e "$GREEN***************************$COL_RESET"
    echo 
    echo -e "$RED   And bro Happy Mining! :) // Afiniel <3 $COL_RESET"
    echo
